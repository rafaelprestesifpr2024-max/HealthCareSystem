...
$sql = "SELECT * FROM pacientes WHERE exibir = 1 ORDER BY id DESC"; 
...
<head> 
    ...
    <style> 
        ...
        .badge { padding: 10px 15px; font-size: 14px; } 
                ...
                <div class="container-fluid px-4"> 
                    ...
                    <?php if (isset($_GET['ocultado'])): ?> 
                        <div class="alert alert-success alert-dismissible fade show mt-3" role="alert"> 
                            ...
                            <strong>Paciente removido da apresentação.</strong> <br> 
                        ...
                        <div class="card-body"> 
                            <?php if ($resultado->num_rows > 0): ?> 
                                    ...
                                    <table class="table table-hover table-bordered"> 
                                        ...
                                        <tbody> 
                                            <?php while ($p = $resultado->fetch_assoc()): ?> 
                                                <tr> 
                                                    ...
                                                    <td> 
                                                        ...
                                                        switch ($p['risco']) { 
                                                            ...
                                                            case "Laranja": $cor = "warning"; break; 
                                                        ...
                                                        ?> 
                                                        <span class="badge bg-<?= $cor ?>"> <?= htmlspecialchars($p['risco']) ?> </span> 
                                                    </td> 
                                                    ...
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap"> 
                                                            <!-- VER FICHA --> 
                                                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#paciente<?= (int)$p['id'] ?>"> 
                                                                <i class="fas fa-eye"></i> Ver ficha 
                                                            </button> 
                                                            
                                                            <!-- REMOVER DA APRESENTAÇÃO --> 
                                                            <form action="ocultar_paciente.php" method="POST" onsubmit="return confirm('Deseja remover este paciente da apresentação? O cadastro continuará salvo no sistema.');"> 
                                                                <input type="hidden" name="id" value="<?= (int)$p['id'] ?>"> 
                                                                <button type="submit" class="btn btn-danger btn-sm"> 
                                                                    <i class="fas fa-eye-slash"></i> Remover da apresentação 
                                                                </button> 
                                                            </form> 
                                                        </div> 
                                                    </td> 
                                                ...
                                                <!-- MODAL DA FICHA --> 
                                                <div class="modal fade" id="paciente<?= (int)$p['id'] ?>" tabindex="-1" aria-hidden="true"> 
                                                    <div class="modal-dialog modal-lg"> 
                                                        <div class="modal-content"> 
                                                            <!-- CABEÇALHO DO MODAL --> 
                                                            <div class="modal-header bg-dark text-white"> 
                                                                <h5 class="modal-title"> 
                                                                    <i class="fas fa-file-medical"></i> Ficha do paciente 
                                                                </h5> 
                                ...
                                <div class="alert alert-info"> 
                                    <i class="fas fa-info-circle"></i> Nenhum paciente disponível para apresentação. 
                                </div> 
                            <?php endif; ?> 
                        </div> 
                    </div> 
